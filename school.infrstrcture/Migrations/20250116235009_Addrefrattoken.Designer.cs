...
namespace school.infrstrcture.Migrations
{
    ...
    [Migration("20250116235009_Addrefrattoken")]
    partial class Addrefrattoken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("school.Data.Entites.DepartmetSubject", b =>
                {
            ...
            modelBuilder.Entity("school.Data.Entites.Subjects", b =>
                {
                    b.Property<int>("SubID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("school.Data.Entites.identity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("school.Data.Entites.identity.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("school.Data.Entites.identity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("school.Data.Entites.DepartmetSubject", b =>
                {
                    ...
                    b.HasOne("school.Data.Entites.Subjects", "Subjects")
            ...
            modelBuilder.Entity("school.Data.Entites.StudentSubject", b =>
                {
                    ...
                    b.HasOne("school.Data.Entites.Subjects", "Subject")
            ...
            modelBuilder.Entity("school.Data.Entites.identity.UserRefreshToken", b =>
                {
                    b.HasOne("school.Data.Entites.identity.User", "user")
